...
case class SharedCollection(_id: Option[String] = None,
...
case class SharedCollectionPackage(packageName: String,
                                   title: String,
                                   description: String,
                                   icon: String,
                                   stars: Double,
...
case class SharedCollectionSubscription(_id: Option[String] = None,
                                        sharedCollectionId: String,
                                        userId: String)


case class AssetResponse(uri: String,
                         title: Option[String] = None,
                         description: Option[String] = None,
                         contentType: Option[String] = None,
                         thumbs: Seq[AssetThumbResponse] = Nil)

case class AssetThumbResponse(url: String,

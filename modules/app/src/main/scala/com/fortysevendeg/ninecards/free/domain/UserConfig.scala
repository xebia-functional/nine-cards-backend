...
case class UserConfig(_id: Option[String] = None,
...
case class UserConfigPlusProfile(`displayName`: Option[String] = None,
                                 `profileImage`: Option[UserConfigProfileImage] = None)

//TODO:This case class should be implemented in the module of GooglePlay. (Now is implementing in Appsly-Server-Apps-Markets-Proxy  generated.models.GooglePlay)
case class UserConfigProfileImage(`imageType`: Option[Int] = None,
                                  `imageUrl`: Option[String] = None,
                                  `secureUrl`: Option[String] = None)

case class UserConfigDevice(deviceId: String,
                            deviceName: String,
                            collections: Seq[UserConfigCollection] = Nil)

case class UserConfigGeoInfo(homeMorning: Option[UserConfigUserLocation] = None,
...
case class UserConfigUserLocation(wifi: Option[String] = None,
                                  lat: Option[Double] = None,
                                  lng: Option[Double] = None,
                                  occurrence: Seq[UserConfigTimeSlot] = Nil)

case class UserConfigStatusInfo(products: Seq[String] = Nil,
...
case class UserConfigCollection(name: String,
...
case class UserConfigCollectionItem(itemType: String,
                                    title: String,
                                    icon: Option[String],
...
case class UserConfigTimeSlot(from: Option[String] = None,

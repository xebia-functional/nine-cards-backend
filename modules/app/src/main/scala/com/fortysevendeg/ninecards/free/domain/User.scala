...
case class AuthData(twitter: Option[TwitterAuthData] = None,
...
case class GoogleAuthData(email: String,
                          devices: List[GoogleAuthDataDeviceInfo])

case class GoogleAuthDataDeviceInfo(name: String,
                                    deviceId: String,
                                    secrectToken: String,
                                    permissions: List[String] = Nil)

case class GoogleOAuth2Data(id: String,
                            accessToken: String,
                            expirationDate: Long)

case class FacebookAuthData(id: String,
                            accessToken: String,
                            expirationDate: Long)

case class TwitterAuthData(id: String,
                           screenName: String,
                           consumerKey: String,
...
case class Installation(_id: Option[String] = None,
                        deviceType: String,

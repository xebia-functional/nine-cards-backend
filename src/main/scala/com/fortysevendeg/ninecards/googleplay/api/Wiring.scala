...
import com.fortysevendeg.ninecards.googleplay.domain.{AppRequest, Item, AppCard, AppMissed}
...
object Wiring {
  ...
  def interpreter(): GooglePlay.Ops ~> Task = {
    ...
    val appService = new XorTaskOrComposer[AppRequest,AppMissed,AppCard](
